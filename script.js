...
const tink = new Audio('https://raw.githubusercontent.com/chirag-23/Black-Jack-Game/main/blackjack/static/sounds/tink.wav');
...
card.src = `https://raw.githubusercontent.com/chirag-23/Black-Jack-Game/main/blackjack/static/${currentCard}.png`;
...
function showScore(activeplayer) {
  if(activeplayer['score']> 21) {
    document.querySelector(activeplayer['scoreSpan']).textContext = "BUST!";
    document.querySelector(activeplayer['scoreSpan']).style.color = "yellow";
    

  }
  else {
    document.querySelector(activeplayer['scoreSpan']).textContext = activeplayer['score'];
  }
}
...
const winSound = new Audio('https://raw.githubusercontent.com/chirag-23/Black-Jack-Game/main/blackjack/static/sounds/cash.mp3');
const cheers = new Audio('https://raw.githubusercontent.com/chirag-23/Black-Jack-Game/main/blackjack/static/sounds/cheer.nav');
const loseSound = new Audio('https://raw.githubusercontent.com/chirag-23/Black-Jack-Game/main/blackjack/static/sounds/aww.mp3');
const drawSound = new Audio('https://raw.githubusercontent.com/chirag-23/Black-Jack-Game/main/blackjack/static/sounds/ohh.mp3');
...
function showResults(winner) {
  if(winner == You) {
    ...
    document.querySelector('#command').textContent = 'you draw';
...
const hitsound = new Audio('https://raw.githubusercontent.com/chirag-23/Black-Jack-Game/main/blackjack/static/sounds/swish.mp4a');
...
document.querySelector('#command').textContent = 'lets play';
